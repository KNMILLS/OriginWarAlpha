...
public class OriginLayers extends SquidLayers {
     ...
     */
    public OriginLayers(int gridWidth, int gridHeight) {
     ...
     */
    public OriginLayers(int gridWidth, int gridHeight, int cellWidth, int cellHeight) {
        this(gridWidth, gridHeight, cellWidth, cellHeight, OriginResources.getSCC(), OriginResources.getSCC());
    }
     ...
     */
    public OriginLayers(int gridWidth, int gridHeight, int cellWidth, int cellHeight, String fontpath) {
        this(gridWidth, gridHeight, cellWidth, cellHeight, fontpath,
                OriginResources.getSCC(), OriginResources.getSCC());
    }
     ...
     */
    public OriginLayers(int gridWidth, int gridHeight, int cellWidth, int cellHeight, BitmapFont bitmapFont) {
     ...
     */
    public OriginLayers(int gridWidth, int gridHeight, int cellWidth, int cellHeight, TextCellFactory tcf) {
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers addExtraLayer() {
     ...
     * @return this for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers setTextSize(int layer, int wide, int high) {
     ...
     * @return this for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers setTextSize(int wide, int high) {
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char c) {
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char c, int foregroundIndex) {
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char c, Color foreground) {
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char c, int foregroundIndex, int backgroundIndex) {
        foregroundPanel.put(x, y, c, foregroundIndex, palette);
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char c, Color foreground, Color background) {
        foregroundPanel.put(x, y, c, foreground);
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char c, int foregroundIndex, int backgroundIndex, int backgroundLightness) {
     ...
     * @param backgroundLightness int between -255 and 255 , lower numbers are darker, higher lighter.
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char c, ArrayList<Color> alternatePalette, int foregroundIndex, int backgroundIndex, int backgroundLightness) {
     ...
     * @param backgroundLightness int between -255 and 255 , lower numbers are darker, higher lighter.
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char c, Color foreground, Color background, int backgroundLightness) {
        foregroundPanel.put(x, y, c, foreground);
        values[x][y] = true;
        lightnesses[x][y] = 256 + clamp(backgroundLightness, -255, 255);
     ...
     * @param backgroundLightness int between -255 and 255 , lower numbers are darker, higher lighter.
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char c, int foregroundIndex, ArrayList<Color> fgPalette, int backgroundIndex, ArrayList<Color> bgPalette, int backgroundLightness) {
     ...
     * @param backgroundLightness int[][] with elements between -255 and 255 , lower darker, higher lighter.
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers put(int x, int y, char[][] c, Color[][] foregrounds, Color[][] backgrounds, int[][] backgroundLightness) {
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putInto(int layer, int x, int y, char c) {
        SquidPanel p = backgroundPanel;
        switch (layer) {
            case 0:
                break;
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putInto(int layer, int x, int y, char c, int colorIndex) {
        SquidPanel p = backgroundPanel;
        switch (layer) {
            case 0:
                break;
     ...
     * @param colorIndex       int index into alternatePalette for the char being drawn
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putInto(int layer, int x, int y, char c, ArrayList<Color> alternatePalette, int colorIndex) {
        SquidPanel p = backgroundPanel;
        switch (layer) {
            case 0:
                break;
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putInto(int layer, int x, int y, char c, Color color) {
        SquidPanel p = backgroundPanel;
        switch (layer) {
            case 0:
                break;
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putInto(int layer, int x, int y, char[][] c, Color[][] colors) {
        SquidPanel p = backgroundPanel;
        switch (layer) {
            case 0:
                break;
     ...
     * @return this, for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putString(int x, int y, String s) {
     ...
     * @return this, for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putString(int x, int y, String s, int foregroundIndex) {
     ...
     * @return this, for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putString(int x, int y, String s, int foregroundIndex, int backgroundIndex) {
        foregroundPanel.put(x, y, s, palette.get(foregroundIndex));
     ...
     * @return this, for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putString(int x, int y, String s, ArrayList<Color> alternatePalette, int foregroundIndex, int backgroundIndex) {
     ...
     * @return this, for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putString(int x, int y, String s, Color foreground, Color background) {
     ...
     * @return this, for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers putBoxedString(int x, int y, String s) {
     ...
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers highlight(int x, int y, int lightness) {
     ...
     * @return this for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers clear(int x, int y) {
        foregroundPanel.clear(x, y);
        values[x][y] = false;
        return this;
    }

    public squidpony.squidgrid.gui.gdx.SquidLayers eraseLayer(int layer) {
     ...
     * @return this, for chaining
     */
    public squidpony.squidgrid.gui.gdx.SquidLayers erase() {
    ...
    public squidpony.squidgrid.gui.gdx.SquidLayers bump(int x, int y, int layer, Direction dir, float duration) {
        SquidPanel p = foregroundPanel;
        switch (layer) {
            case 0:
                p = backgroundPanel;
    ...
    public squidpony.squidgrid.gui.gdx.SquidLayers bump(AnimatedEntity ae, int layer, Direction dir, float duration) {
        SquidPanel p = foregroundPanel;
        switch (layer) {
            case 0:
                p = backgroundPanel;
    ...
    public squidpony.squidgrid.gui.gdx.SquidLayers bump(int x, int y, Direction dir) {
        return bump(x, y, 2, dir, -1);
    }

    public squidpony.squidgrid.gui.gdx.SquidLayers bump(AnimatedEntity ae, Direction dir) {
        return bump(ae, 2, dir, -1);
    }

    public squidpony.squidgrid.gui.gdx.SquidLayers slide(AnimatedEntity ae, int endX, int endY, int layer, float duration) {
        SquidPanel p = foregroundPanel;
        switch (layer) {
            case 0:
                p = backgroundPanel;
    ...
    public squidpony.squidgrid.gui.gdx.SquidLayers slide(int x, int y, int endX, int endY, int layer, float duration) {
        SquidPanel p = foregroundPanel;
        switch (layer) {
            case 0:
                p = backgroundPanel;
    ...
    public squidpony.squidgrid.gui.gdx.SquidLayers slide(int x, int y, int endX, int endY) {
        return slide(x, y, endX, endY, 2, -1);
    }

    public squidpony.squidgrid.gui.gdx.SquidLayers slide(AnimatedEntity ae, int endX, int endY) {
        return slide(ae, endX, endY, 2, -1);
    }

    public squidpony.squidgrid.gui.gdx.SquidLayers wiggle(int x, int y, int layer, float duration) {
        SquidPanel p = foregroundPanel;
        switch (layer) {
            case 0:
                p = backgroundPanel;
    ...
    public squidpony.squidgrid.gui.gdx.SquidLayers wiggle(AnimatedEntity ae, int layer, float duration) {
        SquidPanel p = foregroundPanel;
        switch (layer) {
            case 0:
                p = backgroundPanel;
    ...
    public squidpony.squidgrid.gui.gdx.SquidLayers wiggle(int x, int y) {
        return wiggle(x, y, 2, -1);
    }

    public squidpony.squidgrid.gui.gdx.SquidLayers wiggle(AnimatedEntity ae) {
        return wiggle(ae, 2, -1);
    }

    public squidpony.squidgrid.gui.gdx.SquidLayers tint(int x, int y, Color color, int layer, float duration) {
        SquidPanel p = foregroundPanel;
        switch (layer) {
            case 0:
                p = backgroundPanel;
    ...
    public squidpony.squidgrid.gui.gdx.SquidLayers tint(AnimatedEntity ae, Color color, int layer, float duration) {
        SquidPanel p = foregroundPanel;
        switch (layer) {
            case 0:
                p = backgroundPanel;
    ...
    public squidpony.squidgrid.gui.gdx.SquidLayers tint(int x, int y, Color color) {
        return tint(x, y, color, 2, -1);
    }

    public squidpony.squidgrid.gui.gdx.SquidLayers tint(AnimatedEntity ae, Color color) {
